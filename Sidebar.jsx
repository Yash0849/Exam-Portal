  ...
  return (
    <div className="w-64 bg-purple-950 fixed  h-full px-4 py-2">
        <div className="my-2 mb-9">
            <h1 className="text-2px text-gray-400 font-bold text-2xl p-1 m-2"><img src={icon} alt="" className='w-10 -mt-2 rounded float-start'/>ProExamer
            </h1></div>
    <ul className="mt-3 text-white ">
        ...
        <li className="mb-8  hover:shadow hover:bg-purple-900 py-2">
        <NavLink to="/courses" className="px-3"><LibraryBooksIcon className="inline-block w-6 h-6 mr-2 -mt-2"></LibraryBooksIcon>Courses</NavLink>
        </li>
        <li className="mb-8  hover:shadow hover:bg-purple-900 py-2">
        <NavLink to="/pyqs" className="px-3"><FolderCopyIcon className="inline-block w-6 h-6 mr-2 -mt-2"></FolderCopyIcon>PYQS questions</NavLink>
        </li>
        <li className="mb-8  hover:shadow hover:bg-purple-900 py-2">
        <NavLink to="/conductexam" className="px-3"><NoteAltIcon className="inline-block w-6 h-6 mr-2 -mt-2"></NoteAltIcon>Conduct Exam</NavLink>
        </li>
        <li className="mb-8  hover:shadow hover:bg-purple-900 py-2">
